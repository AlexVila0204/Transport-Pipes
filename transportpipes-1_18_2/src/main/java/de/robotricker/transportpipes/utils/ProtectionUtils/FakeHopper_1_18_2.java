...
public class FakeHopper_1_18_2 implements Hopper {
    ...
    public FakeHopper_1_18_2(World world, Location location, Block block) {
        this.world = world;
        this.location = location;
        this.block = block;
        this.inventory = Bukkit.createInventory(null, InventoryType.HOPPER);
        this.data = ((FakeBlock_1_18_2) block).getNMS();
