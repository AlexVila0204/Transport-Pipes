...
public class FakeBlock_1_18_2 extends FakeBlock implements Block {

    public IBlockData getNMS() {
        return ((CraftBlockData) Material.HOPPER.createBlockData()).getState();
    }

    public FakeBlock_1_18_2(World world, Location location, Material material) {
        this.world = world;
        this.location = location;
        this.material = Material.HOPPER;
        this.blockData = this.material.createBlockData();
        this.hopper = new FakeHopper_1_18_2(world, location, this);
    }
