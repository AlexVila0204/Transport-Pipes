...
public class FakeBlock_26_1 extends FakeBlock implements Block {

    public FakeBlock_26_1(World world, Location location, Material material) {
        this.world = world;
        this.location = location;
        this.material = Material.HOPPER;
        this.blockData = this.material.createBlockData();
        this.hopper = new FakeHopper_26_1(world, location, this);
    }
