...
public class FakeHopper_26_1 implements Hopper {
    ...
    public FakeHopper_26_1(World world, Location location, Block block) {
        this.world = world;
    ...
    public @NotNull BlockState copy() {
        FakeHopper_26_1 copy = new FakeHopper_26_1(world, location.clone(), block);
    ...
    public @NotNull BlockState copy(@NotNull Location location) {
        ...
        FakeHopper_26_1 copy = new FakeHopper_26_1(location.getWorld(), location.clone(), targetBlock);
