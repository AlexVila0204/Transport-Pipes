...
export default defineConfig({
  ...
  description:
    "Official Documentation for the Transport-Pipes Minecraft Plugin",
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "3. Test World", link: "/tutorials/test-world" },
        ],
      },
      {
        text: "How-To Guides",
        ...
        items: [
          {
            text: "Filter Items (Golden Pipes)",
            link: "/how-to/filtering-items",
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "History & Dependencies",
            link: "/reference/history-dependencies",
          },
      ...
      },
      {
        ...
        items: [
          {
            text: "Render Systems (Vanilla vs Modeled)",
            link: "/explanation/render-systems",
          },
          {
            text: "Performance & Tick System",
            link: "/explanation/performance",
          },
        ],
      },
    ],
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/AlexVila0204/Transport-Pipes",
      },
    ],
  },
});
