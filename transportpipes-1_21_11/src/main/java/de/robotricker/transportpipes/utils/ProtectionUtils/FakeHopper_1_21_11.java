...
public class FakeHopper_1_21_11 implements Hopper {
    ...
    public FakeHopper_1_21_11(World world, Location location, Block block) {
        this.world = world;
        this.location = location;
        this.block = block;
        this.inventory = Bukkit.createInventory(null, InventoryType.HOPPER);
        this.blockData = Material.HOPPER.createBlockData();
        this.persistentDataContainer = new ItemStack(Material.STONE).getItemMeta().getPersistentDataContainer();
    }
    ...
    public MaterialData getData() {
        return new MaterialData(Material.HOPPER);
    }
    ...
    public @NotNull BlockState copy() {
        FakeHopper_1_21_11 copy = new FakeHopper_1_21_11(world, location.clone(), block);

        if (this.inventory != null && this.inventory.getContents() != null) {
            copy.getInventory().setContents(this.inventory.getContents().clone());
        }
    ...
    public @NotNull BlockState copy(@NotNull Location location) {
        ...
        FakeHopper_1_21_11 copy = new FakeHopper_1_21_11(location.getWorld(), location.clone(), targetBlock);
