...
public class FakeHopper_1_21_9 implements Hopper {
    ...
    public FakeHopper_1_21_9(World world, Location location, Block block) {
        this.world = world;
    ...
    public @NotNull BlockState copy() {
        FakeHopper_1_21_9 copy = new FakeHopper_1_21_9(world, location.clone(), block);
    ...
    public @NotNull BlockState copy(@NotNull Location location) {
        ...
        FakeHopper_1_21_9 copy = new FakeHopper_1_21_9(location.getWorld(), location.clone(), targetBlock);
