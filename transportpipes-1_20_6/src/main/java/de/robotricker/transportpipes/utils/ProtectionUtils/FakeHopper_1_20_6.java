...
public class FakeHopper_1_20_6 implements Hopper {
    ...
    public FakeHopper_1_20_6(World world, Location location, Block block) {
        this.world = world;
    ...
    public BlockState copy() {
        return new FakeHopper_1_20_6(world, location.clone(), block);
    }
