...
public class FakeBlock_1_21_5 extends FakeBlock implements Block {

    public FakeBlock_1_21_5(World world, Location location, Material material) {
        this.world = world;
        this.location = location;
        this.material = Material.HOPPER;
        this.blockData = this.material.createBlockData();
        this.hopper = new FakeHopper_1_21_5(world, location, this);
    }
