...
public class FakeBlock_1_21_4 extends FakeBlock implements Block {

    public FakeBlock_1_21_4(World world, Location location, Material material) {
        this.world = world;
        this.location = location;
        this.material = Material.HOPPER;
        this.blockData = this.material.createBlockData();
        this.hopper = new FakeHopper_1_21_4(world, location, this);
    }
